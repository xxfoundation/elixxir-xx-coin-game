...
import (
	...
	"git.xx.network/elixxir/client/api"
	"git.xx.network/elixxir/client/interfaces/contact"
	"git.xx.network/elixxir/client/interfaces/message"
	"git.xx.network/elixxir/client/interfaces/params"
	"git.xx.network/elixxir/client/single"
	"git.xx.network/elixxir/client/switchboard"
	"git.xx.network/elixxir/xx-coin-game/crypto"
	"git.xx.network/elixxir/xx-coin-game/game"
	"git.xx.network/elixxir/xx-coin-game/io"
	"io/ioutil"
	"os"
	"sync/atomic"
	"time"
